...
function premiumInputStyle(night:boolean): React.CSSProperties {
  return {
    ...
    borderWidth: "1.5px",
    borderStyle: "solid",
    borderColor: night ? "rgba(46,32,16,1)" : "rgba(216,203,184,1)",
...
function PremiumButton({
  ...
  return (
    <motion.button
      ...
      className="flex h-11 min-w-0 items-center justify-center gap-2 rounded-full px-4 text-[12px] font-bold disabled:opacity-60"
      style={styles}
    >
      {icon}
      {children}
  ...
  return (
    ...
    >
      ...
      <div className="px-4 pb-4 pt-4 sm:px-5 sm:pb-5">
        ...
        <div className={`serif mt-1 text-[26px] leading-none sm:text-[30px] ${night ? "text-[#e8dcc8]" : "text-[#1a1510]"}`}>{title}</div>
      ...
      >
        ...
        <AnimatePresence>
          {errorMessage && (
            <motion.div
              ...
              className="fixed left-1/2 top-3 z-[80] max-w-[calc(100vw-1.5rem)] -translate-x-1/2 rounded-2xl px-4 py-2.5 text-center text-[13px] font-bold sm:top-5 sm:rounded-full sm:px-5"
              style={{
        ...
        <div className="relative z-10 mx-auto max-w-[1450px] px-3 py-4 pb-[max(1rem,env(safe-area-inset-bottom))] sm:px-4 sm:py-5 md:px-6 lg:py-6">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            className="relative mb-5 overflow-hidden rounded-[24px] p-4 sm:mb-6 sm:rounded-[30px] sm:p-6"
            style={glassCard(night)}
          >
            <div className="absolute left-0 right-0 top-0 h-[2px]" style={{ background:"linear-gradient(90deg, transparent, #c8892a, transparent)" }} />
            <div className="grid items-center gap-5 lg:grid-cols-[1.1fr_0.9fr] lg:gap-6">
              <div className="flex min-w-0 items-center gap-5">
                ...
                <div className="min-w-0">
                  ...
                  <h1 className={`serif mt-2 text-[34px] leading-[0.98] sm:text-4xl md:text-5xl ${night ? "text-[#e8dcc8]" : "text-[#1a1510]"}`}>
          ...
          <div className="grid min-w-0 gap-5 xl:grid-cols-[minmax(0,1.4fr)_minmax(320px,0.9fr)]">
            <div className="min-w-0 space-y-5">
              ...
              >
                <div className="grid gap-4 sm:grid-cols-2">
                  <PremiumField label="Full Name" night={night} className="sm:col-span-2">
                    <PremiumInput
              ...
              >
                <div className="grid gap-4 sm:grid-cols-2">
                  <PremiumField label="Role" night={night} className="sm:col-span-2">
                      ...
                      {roleOptions.map((r) => {
                        ...
                        return (
                          <motion.button
                            ...
                            whileTap={{ scale: 0.97 }}
                            className="flex min-h-10 items-center justify-center gap-2 rounded-full px-3 py-2 text-[12px] font-bold sm:justify-start sm:px-4"
                            style={{
                              background: active
                      ...
                      {statusOptions.map((s) => {
                        ...
                        return (
                          <motion.button
                            ...
                            whileTap={{ scale: 0.97 }}
                            className="min-h-11 rounded-[16px] px-2 py-2.5 text-[11px] font-bold sm:px-3"
                            style={{
                              background: active
                                ? "linear-gradient(135deg,#a07020,#d4a352)"
                                : (night ? "rgba(255,255,255,0.03)" : "rgba(255,255,255,0.72)"),
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <PremiumField label="Notes" night={night} className="sm:col-span-2">
                    <textarea
                      ...
                      className="min-h-[110px] min-w-0 w-full resize-none rounded-[16px] px-4 py-3 text-base outline-none sm:text-sm"
                      style={premiumInputStyle(night)}
                    />
                  </PremiumField>
                </div>
            ...
            <motion.div
              ...
              transition={{ duration: 0.45 }}
            >
              <div className="overflow-hidden rounded-[24px] sm:rounded-[28px] xl:sticky xl:top-5" style={glassCard(night)}>
                <div className="border-b px-4 py-4 sm:px-5" style={{borderColor:night ? "rgba(255,255,255,0.05)" : "rgba(216,203,184,0.7)"}}>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className={`serif text-[25px] leading-none sm:text-[28px] ${night ? "text-[#e8dcc8]" : "text-[#1a1510]"}`}>
                        Staff Summary
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-4 p-4 sm:p-5">
                  <motion.div
                    layout
                    className="overflow-hidden rounded-[22px] p-4 sm:rounded-[24px] sm:p-5"
                    style={{
                      background: night
                    ...
                    <div className="mb-4 flex min-w-0 items-center gap-3 sm:gap-4">
                      <div className="relative">
                        {imagePreview ? (
                          ...
                          <div
                            className="flex h-16 w-16 items-center justify-center rounded-full text-lg font-bold sm:h-20 sm:w-20 sm:text-xl"
                            style={{
                  ...
                  <div className="grid gap-2">
                    {[
                      ...
                      >
                        ...
                        <div className={`break-words text-[13px] font-bold ${night ? "text-[#e8dcc8]" : "text-[#1a1510]"}`}>
                          {item.value}
                        </div>
                      </motion.div>
                    ))}
