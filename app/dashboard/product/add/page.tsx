      ...
      <div className="mx-auto max-w-7xl space-y-5">
        ...
        {mode === "single" ? (
          ...
          >
            ...
            <div className="single-layout grid gap-5 xl:grid-cols-[1.25fr_0.75fr]">
              <div className="min-w-0">
              ...
              <div className="single-preview space-y-5">
                <section className={cn("rounded-2xl border p-5", t.aiPanel)}>
                  ...
                  <div
                    className={cn(
                      "image-preview mt-3 flex min-h-[200px] items-center justify-center overflow-hidden rounded-2xl border",
                      t.previewCard,
                    )}
                  >
                    {preview ? (
                  ...
                  {bulkRows.map((row, index) => {
                    ...
                    return (
                      <tr key={row.rowId}>
                        ...
                        <td data-label="Stock" className="px-3 py-3 align-top">
                          <Input
                            type="number"
