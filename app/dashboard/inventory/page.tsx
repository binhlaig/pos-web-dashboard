...
const tk = (theme: Theme) =>
  theme === "dark"
    ? {
        root: "bg-transparent text-slate-100",
        text: "text-white",
        textMuted: "text-slate-400",
        textSubtle: "text-slate-500",
        card: "border-white/10 bg-[#293750] shadow-sm",
        input:
          "border-white/10 bg-[#33435f] text-white placeholder:text-slate-400 focus-visible:border-blue-400 focus-visible:ring-blue-400/20",
        btn: "border-white/10 bg-[#33435f] text-slate-200 hover:bg-[#3b4d6d] hover:text-white",
        btnPrimary:
        ...
        tableRow: "border-white/[0.07] hover:bg-white/[0.05]",
        tableBorder: "border-white/10",
        track: "bg-[#33435f]",
        dropMenu: "bg-[#293750] border-white/10",
        dropItem:
          "text-slate-300 hover:text-white focus:text-white hover:bg-white/10 focus:bg-white/10",
        segActive: "bg-blue-600 text-white",
        segInactive: "text-slate-400 hover:text-white",
        catActive: "border-blue-500 bg-blue-600 text-white shadow-sm",
        catInactive:
          "border-white/10 bg-[#33435f] text-slate-300 hover:bg-[#3b4d6d] hover:text-white",
      }
    : {
        ...
        catActive: "border-blue-600 bg-blue-600 text-white shadow-sm",
        catInactive:
  ...
  return (
    <button
      ...
      className={cn(
        ...
        active ? "border-transparent bg-blue-600 text-white shadow-sm" : t.btn,
        className,
      )}
    >
      {children}
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1520px] space-y-5">
        ...
        >
          <div>
            <div className="pb-2">
              <div
                className={cn(
                  "mb-2.5 inline-flex items-center gap-2 rounded-full border border-blue-500/20 bg-blue-500/10 px-3 py-1.5 text-[11px] font-semibold text-blue-500",
                )}
              >
          ...
          <div className="flex w-full flex-wrap items-center gap-2.5 lg:w-auto lg:justify-end">
            <div className="relative w-full sm:w-[260px]">
              ...
              <Input
                ...
                className={cn(
                  "h-10 w-full rounded-xl pl-9 text-[13px]",
                  t.input,
                )}
              />
            </div>
            ...
            <button
              ...
              onClick={exportCsv}
              className={cn(
                "flex h-10 items-center gap-1.5 rounded-xl border px-3.5 text-[13px] font-semibold",
                t.btn,
              )}
            >
            ...
            <button
              ...
              className={cn(
                "flex h-10 items-center gap-1.5 rounded-xl px-4 text-[13px] font-bold",
                t.btnPrimary,
              )}
            >
        ...
        >
          <div className={cn("overflow-hidden rounded-2xl border", t.card)}>
              ...
              <div className="flex flex-wrap items-center gap-2">
                <select
                  ...
                  className={cn(
                    ...
                    theme === "dark"
                      ? "border-white/10 bg-[#33435f] text-slate-200"
